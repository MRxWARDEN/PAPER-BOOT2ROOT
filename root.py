...
print ("**************")
print("Exploit: TOOL TO GET ROOT ACCESS # CVE-2021-3560")
print("Exploit code written by MR.x WARDEN")
print("Original exploit author Kevin Backhouse  ")
print("For more details check this out: https://github.com/MRxWARDEN ")
print ("**************")
